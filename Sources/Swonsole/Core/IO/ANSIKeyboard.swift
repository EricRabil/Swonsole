...
private func isLetter(_ key: Int) -> Bool {
    return (65...90 ~= key)
}

private func isNumber(_ key: Int) -> Bool {
    return (48...57 ~= key)
}

private func isLetter(_ chr: Character) -> Bool {
    return ("A"..."Z" ~= chr)
}

private func isNumber(_ chr: Character) -> Bool {
    return ("0"..."9" ~= chr)
}

private func isLetter(_ str: String) -> Bool {
    return ("A"..."Z" ~= str)
}
...
public struct ANSIPayload {
    public private(set) var code: ANSIKeyCode
    public private(set) var meta: [ANSIMetaCode]
    public private(set) var chars: [Character]
}

// read ANSI key code sequence
public extension _ANSITerminalInterface {
    func readKey() -> ANSIPayload {
        ...
        return ANSIPayload(code: code, meta: meta, chars: chars)
    }
}
